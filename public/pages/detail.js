...
import { icons, formatDate, escapeHtml } from '../scripts/utils.js';
...
export async function renderDetailPage(termId) {
  try {
    ...
    return `
          ...
          <section class="detail-page">
            ...
            <div class="detail-header">
              <div class="detail-header__top">
                <h1 class="detail-header__title">${escapeHtml(term.term)}</h1>
              ...
              <div class="detail-header__meta">
                <span class="badge badge--primary">${escapeHtml(term.category)}</span>
            ...
            <div class="detail-content">
              <div class="detail-content__section">
                ...
                <p class="detail-content__text">${escapeHtml(term.shortDefinition)}</p>
              </div>
      ...
      `<span class="detail-related__item" data-related="${escapeHtml(rt)}">${escapeHtml(rt)}</span>`
    ).join('')}
                  </div>
                </div>
              ` : ''}
